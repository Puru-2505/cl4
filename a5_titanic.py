...
def map_reduce_with_pandas(input_file):
    ...
    # Map: Filter deceased females and transform data for count by class calculation
...
if __name__ == "__main__":
    input_file = r'D:\acl3cl4\cl4exam\Titanic-Dataset.csv'  # Update this to the path of your Titanic dataset CSV file
